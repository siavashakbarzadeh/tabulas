...
const TermsPolicyPage = () => {
  return (
    <>
        <Head title="Terms / Policy" />
        <div className="relative lg:max-w-[960px] mx-auto">
            <div className="pb-6 sm:pb-10 text-center md:max-w-[720px] mx-auto">
                <h2 className="mb-4 font-normal text-3xl lg:text-4xl leading-tighter tracking-tight text-slate-700 dark:text-white font-heading">Terms &amp; Policy</h2>
                <p className="text-lg text-slate-600 mb-4">We are on a mission to make the web a better place. The following terms, as well as our Policy and Terms of Service, apply to all users.</p>
                <em className="text-sm mb-3 relative font-normal text-slate-400">Last Update: Jan 12, 2022</em>
            </div>
