  ...
  return (
    <div className="flex flex-col min-h-screen w-full">
      <div className="flex-1 bg-white rounded-2xl relative p-4">
        <h1 className="text-xl font-bold text-red-800 mb-4">Ultimi Atti Pubblicati</h1>
        <div 
