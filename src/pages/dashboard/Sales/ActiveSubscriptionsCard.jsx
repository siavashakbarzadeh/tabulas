...
const ActiveSubscriptionsCard = ({className}) => {
  const chart = {
    ...
    <Card className="h-full">
        <Card.Body>
            <div className="flex justify-between items-start gap-2 mb-3">
                <div>
                    <h6 className="font-heading text-base -tracking-snug leading-tighter font-bold text-slate-700 dark:text-white">Active Subscriptions</h6>
                </div>
                <TooltipComponent content="Total active subscription" placement="left" rtlPlacement="right" >
            ...
            <div className="flex items-end sm:flex-wrap gap-3 md:flex-nowrap">
                <div className="flex-shrink-0 box-border">
                    <span className="block text-3xl text-slate-700 dark:text-white">9.69K</span>
                    <span className="text-xs text-slate-400">
                        <span className="change down text-red-600 me-1"><Icon name="arrow-long-down"></Icon>1.93%</span>
                        since last month
                    </span>
                </div>
